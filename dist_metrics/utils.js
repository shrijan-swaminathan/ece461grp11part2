...
export async function normalizeGitHubUrl(url) {
...
export async function getGitHubURLfromNPM(url) {
    let packageURL = url;
...
export function contains(arr, q) {
...
export async function extractInfoFromSSH(sshUrl) {
